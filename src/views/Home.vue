<template>
  ...
  <template v-if="!isLoggedIn">
    ...
    <el-button @click="$router.push('/register')" style="margin-left: 10px;">注册</el-button>
  </template>
  ...
  <template v-else>
    ...
    <el-dropdown @command="handleCommand" style="margin-left: 20px;">
      <span class="el-dropdown-link" style="cursor: pointer; display: flex; align-items: center; color: #409eff; font-weight: bold;">
