<template>
  <div class="profile-container">
    ...
    <el-card class="box-card">
      ...
      <el-table :data="examRecords" v-loading="loading" stripe style="width: 100%" empty-text="暂无考试记录">
    ...
    <el-dialog v-model="evaluationVisible" title="💡 AI 综合考试评价" width="600px" destroy-on-close>
